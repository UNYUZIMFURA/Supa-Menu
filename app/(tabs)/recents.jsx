    ...
    <SafeAreaView>
      <ScrollView className="h-full pt-6 px-6 bg-[#f3f4f6]">
        <View className="flex-col w-full items-center">
          ...
          <Text className="text-secondary mt-4 text-lg font-bold">
            Jane
          </Text>
          <Text className="text-third text-xs mt-2">Star Customer</Text>
        </View>
        <View className="flex-col w-full py-4">
                  <PaymentMethod image={masterCardImg} accountNo="123 **** **** **** 2341" name="Master Card"/>
                  <PaymentMethod image={airtelImg}  accountNo="0738000055" name="Airtel Money"/>
        </View>
